package com.example.tk_app.HMac.Api;


import android.util.Log;

import com.example.tk_app.HMac.Constant.AppInfo;
import com.example.tk_app.HMac.Helper.Helpers;
     ...
     public JSONObject createOrder(String amount) throws Exception {
        ...
        JSONObject data = HttpProvider.sendPost(AppInfo.URL_CREATE_ORDER, formBody);
         ...
         try {
             ...
             String formBodyText = buffer.readUtf8();
             Log.d("YourTag", "Form Body Text: " + formBodyText);
         } catch (IOException e) {
             e.printStackTrace();
         }
        return data;
