...
class AdminProductsPhoneAdapter (private val products2: List<ProductPhone>) : RecyclerView.Adapter<AdminProductsPhoneAdapter.ViewHolder>() {
...
//        } ?: ""
        ...
        holder.itemView.setOnClickListener {
            val intent = Intent(holder.itemView.context, AdminDetailPhoneActivity::class.java)
            val productmenId = product.productmenId
            intent.putExtra("productmenId", productmenId)
