...
class AdminProductsEarPhoneAdapter (private val products2: List<ProductEarPhonesAccessories>) : RecyclerView.Adapter<AdminProductsEarPhoneAdapter.ViewHolder>() {
...
//        } ?: ""
        ...
        holder.itemView.setOnClickListener {
            val intent = Intent(holder.itemView.context, AdminDetailEarPhoneActivity::class.java)
            val productphoneId = product.productphoneId
            intent.putExtra("productphoneId", productphoneId)
