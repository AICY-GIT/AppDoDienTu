...
class AdminDetailWatchActivity : AppCompatActivity() {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    ...
                    if (product != null) {
                        ...
                        if (!isDestroyed) {
                            Glide.with(this@AdminDetailWatchActivity)
    ...
    private fun saveImageToStorage(imageUri: Uri) {
        val storageReference =
            FirebaseStorage.getInstance().reference.child("admin_add_product/electronic_device/$uid2/$productId.jpg")
