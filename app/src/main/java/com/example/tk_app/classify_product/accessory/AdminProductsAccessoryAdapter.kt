...
class AdminProductsAccessoryAdapter (private val products2: List<ProductAccessory>) : RecyclerView.Adapter<AdminProductsAccessoryAdapter.ViewHolder>() {
...
//        } ?: ""
        ...
        holder.itemView.setOnClickListener {
            val intent = Intent(holder.itemView.context, AdminDetailAccessoryActivity::class.java)
