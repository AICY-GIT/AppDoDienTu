...
class AdminDetailPhoneActivity : AppCompatActivity() {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    ...
                    if (product != null) {
                        ...
                        if (!isDestroyed) {
                            Glide.with(this@AdminDetailPhoneActivity)
    ...
    private fun saveImageToStorage(imageUri: Uri) {
        val storageReference =
            FirebaseStorage.getInstance().reference.child("admin_add_product/product_men_fashion/$uid2/$productId.jpg")
